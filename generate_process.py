# This  looks for folders inside user uploads and converts them to reel if they are not converted
    ...
    while True:
        ...
        for folder in folders:
            if(folder not in done_folders): 
                text_to_audio(folder) # Generates the audio
                create_reel(folder) # Used to convert the images and audio.mp3 inside the folder
